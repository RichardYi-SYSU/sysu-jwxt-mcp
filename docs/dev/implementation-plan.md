...
Build a local agent-facing integration for reading key teaching-affairs data from the SYSU teaching affairs system for the currently authorized user.
...
5. Hardening
   ...
   - Keep compatibility notes for both the MCP server and the REST debug surface.
6. MCP packaging
